...
public class ConsumersCooperativeStrategy extends KafkaBaseClass {
    private static final Logger _log = LoggerFactory.getLogger(ConsumersCooperativeStrategy.class.getSimpleName());
    ...
    public static void main(String[] args) {
        ...
        // changing to sticky partition strategy
